...
import com.ledger.domain.CreditAccount;
...
public class DebtPaymentDAO {
    ...
    @SuppressWarnings("SqlResolve")
    public List<Transaction> getTransactionsByAccount(CreditAccount account) {
        ...
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
            ...
            System.err.println("SQL Exception retrieving debt payment transactions: " + e.getMessage());
            return List.of();
        }
    }
}
