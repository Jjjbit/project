...
CREATE TABLE IF NOT EXISTS transactions (
    ...
    show_in_ledger BOOLEAN DEFAULT FALSE,
    FOREIGN KEY (ledger_id) REFERENCES ledgers(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS reimbursement_plan (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    --original_transaction_id BIGINT NOT NULL UNIQUE,
    amount DECIMAL(15,2) NOT NULL DEFAULT 0.00,
    is_ended BOOLEAN NOT NULL DEFAULT FALSE,
    --reimbursement_status VARCHAR(10) NOT NULL DEFAULT 'PENDING' CHECK (reimbursement_status IN ('PENDING','FULL','NONE')),
    ledger_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS reimbursement_tx_link (
    reimbursement_plan_id BIGINT NOT NULL,
    reimbursement_transaction_id BIGINT NOT NULL UNIQUE,

    PRIMARY KEY (reimbursement_plan_id, reimbursement_transaction_id),

    FOREIGN KEY (reimbursement_plan_id) REFERENCES reimbursement_plan(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS reimbursement_record (
    ...
    reimbursement_transaction_id BIGINT NOT NULL UNIQUE,
    reimbursement_income_id BIGINT,
    to_account BIGINT NOT NULL,
    amount DECIMAL(15,2) NOT NULL,
    record_date DATE NOT NULL,
    FOREIGN KEY (original_transaction_id) REFERENCES transactions(id) ON DELETE CASCADE,
    FOREIGN KEY (reimbursement_transaction_id) REFERENCES transactions(id) ON DELETE CASCADE,
    FOREIGN KEY (reimbursement_income_id) REFERENCES transactions(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS installment_payments (
    ...
    PRIMARY KEY (installment_id, transaction_id),
...
CREATE TABLE IF NOT EXISTS debt_payments (
    ...
    FOREIGN KEY (account_id) REFERENCES credit_account(id) ON DELETE CASCADE,
    FOREIGN KEY (transaction_id) REFERENCES transactions(id) ON DELETE CASCADE
);
